...
# # count = 1
# 
# home_page_url_list = [first_home_page_url + "page/" + str(num) + "/" for num in range(1002, home_page_total_number + 1)]
# home_page_url_list = list(zip(range(1002, home_page_total_number + 1), home_page_url_list))
# count = 20005
# 
