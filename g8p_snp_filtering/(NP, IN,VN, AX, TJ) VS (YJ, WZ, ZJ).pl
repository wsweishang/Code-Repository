...
open (OUT,">G:/(NP, IN,VN, AX, TJ) VS (YJ, WZ, ZJ).txt");
my %compared_data=();
my @population_compared_filenames=qw/YJ_S2_snp_snpEff_genes.txt WZ_S1_snp_snpEff_genes.txt ZQ_S4_snp_snpEff_genes.txt/;
...
my @population_compare_filenames=qw/NP_S1_snp_snpEff_genes.txt IN_S2_snp_snpEff_genes.txt VN_S3_snp_snpEff_genes.txt AX_S4_snp_snpEff_genes.txt TJ_S3_snp_snpEff_genes.txt/;
