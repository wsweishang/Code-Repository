...
open (INGFF,"<E:/gff_change_postion/C_idella_female_genemodels.v1.gmap.gff");
open (INTXT,"<E:/gff_change_postion/Cid_AnchorLGmapNew_0624_263scafford_GoldenpathonLGmapScaffoldLoci.txt");
open (OUT,">E:/gff_change_postion/C_idella_female_genemodels.v1.gmap_changedposition_LG_v3.gff");
my @ingff=<INGFF>;
my @intxt=<INTXT>;
